#!/bin/bash -l
#SBATCH --job-name=sv3_t_maz
#SBATCH --partition=gh200q
#SBATCH --gres=gpu:1
#SBATCH --output=/home/thheim/HMR/logs/shrekv3_tiny_maze_%j.log
#SBATCH --error=/home/thheim/HMR/logs/shrekv3_tiny_maze_%j.err
