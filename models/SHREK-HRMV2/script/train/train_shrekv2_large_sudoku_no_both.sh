#!/bin/bash -l
#SBATCH --job-name=sv2_no_both
#SBATCH --partition=gh200q
#SBATCH --gres=gpu:1
#SBATCH --output=/home/thheim/HMR/logs/shrekv2_large_no_both_%j.log
#SBATCH --error=/home/thheim/HMR/logs/shrekv2_large_no_both_%j.err
...
OMP_NUM_THREADS=8 python3 pretrain.py \
    ...
    +run_name=SHREKV2_Large_No_Both \
