#!/bin/bash -l
#SBATCH --job-name=sv2_full
#SBATCH --partition=gh200q
#SBATCH --gres=gpu:1
#SBATCH --output=/home/thheim/HMR/logs/shrekv2_large_full_%j.log
#SBATCH --error=/home/thheim/HMR/logs/shrekv2_large_full_%j.err
