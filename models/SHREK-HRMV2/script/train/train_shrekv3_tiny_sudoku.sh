#!/bin/bash -l
#SBATCH --job-name=sv3_t_sud
#SBATCH --partition=gh200q
#SBATCH --gres=gpu:1
#SBATCH --output=/home/thheim/HMR/logs/shrekv3_tiny_sudoku_%j.log
#SBATCH --error=/home/thheim/HMR/logs/shrekv3_tiny_sudoku_%j.err
