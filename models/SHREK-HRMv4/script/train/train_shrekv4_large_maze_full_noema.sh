#!/bin/bash -l
#SBATCH --job-name=sv4_l_maz_nem
#SBATCH --partition=gh200q
#SBATCH --gres=gpu:1
#SBATCH --output=/home/thheim/HMR/logs/shrekv4_large_maze_noema_%j.log
#SBATCH --error=/home/thheim/HMR/logs/shrekv4_large_maze_noema_%j.err
...
OMP_NUM_THREADS=8 python3 pretrain.py \
    ...
    +run_name=SHREKV4_Large_Maze_Full_NoEMA \
